  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8" id='pricing'>
      <div className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl" aria-hidden="true">
        <div
          className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#b6b5ff] to-[#00039b] opacity-10"
          style={{
            clipPath:
        ...
        {tiers.map((tier, tierIdx) => (
          ...
          >
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ? 'bg-white text-gray-700 shadow-sm hover:bg-gray-400 focus-visible:outline-gray-500'
